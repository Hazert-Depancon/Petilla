...
import 'package:petilla_app_project/general_widgets/ads/ads_detail_view.dart';
import 'package:petilla_app_project/theme/light_theme_colors.dart';

class AdsWidget extends StatefulWidget {
  const AdsWidget({Key? key, required this.images, required this.titles}) : super(key: key);
