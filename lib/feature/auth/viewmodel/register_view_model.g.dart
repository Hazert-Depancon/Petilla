...
mixin _$RegisterViewModel on _RegisterViewModelBase, Store {
  late final _$onRegisterButtonAsyncAction =
      AsyncAction('_RegisterViewModelBase.onRegisterButton', context: context);

  @override
  Future<void> onRegisterButton(dynamic email, dynamic password, dynamic name) {
    return _$onRegisterButtonAsyncAction
        .run(() => super.onRegisterButton(email, password, name));
  }
